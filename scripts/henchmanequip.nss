...
void main()
{
    ...
    if (oBag != OBJECT_INVALID) {
        ...
        // Destroying the bag is key as it causes the possessor of the items
        // that were in the bag to be set equal to null, so that they can be
        // identified as having been put in the bag in the first place.
        // Do you think this is clumsy? Well how about the fact that
        // GetFirstItemInInventory() and GetNextItemInInventory() cause the
        // NWN to crash???

        DestroyObject(oBag,0.);
