...
void main()
{
    ...
    switch (d100()) {
      case 1: SpeakString("Ah, but I could use a fresh ale!"); break;
      ...
      case 6: SpeakString("Heck of a day!  Heck of a day!"); break;
      case 7: SpeakString("Get this, get that.  Grrr, that woman is gonna drive me to my grave!"); break;
      case 8: ActionPlayAnimation(ANIMATION_FIREFORGET_PAUSE_SCRATCH_HEAD); break;
      case 9: SpeakString("I should grab a cot and get some sleep."); break;
      case 10: SpeakString("Oh, but there are some fine lookin' women in these parts."); break;
