...
//    }
    ...
    int iSwitch = GetLocalInt(GetObjectByTag("EnterTriggerA6"), "Tripped");
    object oChief = GetObjectByTag("KabaltGoblin5");
    if (iSwitch > 0 && !GetIsInCombat())
    {
        ActionForceFollowObject(oChief, 1.0);
    }
}
